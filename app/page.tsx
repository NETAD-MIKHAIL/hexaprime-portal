...
export default function Home() {
  ...
  return (
    ...
    <section className="relative w-full min-h-screen flex items-center justify-center">
      ...
      {/* Mission Section */}
      <section className="max-w-6xl items-center text-center py-16 px-4 md:px-16 bg-black text-white">
        <h2 className="text-center text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent leading-snug sm:leading-tight">Our Mission</h2>
        <p className="mt-5 ">
